  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-brand/5 to-transparent">
      ...
      <main className="container-shell py-16">
        <Suspense fallback={
          <div className="rounded-2xl border border-border/50 bg-white p-10 text-center shadow-sm max-w-lg mx-auto">
            <div className="flex justify-center mb-4"><Loader2 className="h-12 w-12 text-brand animate-spin" /></div>
            <h1 className="text-xl font-bold text-brand-deep mb-2">Loading Payment Details</h1>
          </div>
        }>
          <FapshiSuccessContent />
        </Suspense>
      </main>
      <SiteFooter />
    </div>
